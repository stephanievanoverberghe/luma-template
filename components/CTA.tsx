        ...
        <section id="get" className="section">
            <div className="container">
                <div className="card p-8 text-center">
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Launch faster with a clean, minimal base.</h2>
                    ...
                    <p className="mt-6 text-sm text-muted">No dependencies. No backend. Just ship.</p>
                </div>
            </div>
        </section>
    );
